												...
												<div class="lista_portfolio_txts">
													...
													<div class="lista_portfolio_titulo">
														<a class="lista_portfolio_a" title="" href="#">
															<header class="header_article">
																<h3 class="lista_portfolio_h3 transitions5 hzmp"><?php echo $post['titulo']; ?></h3>
															</header>
														</a>
													</div>
													...
													<div class="lista_portfolio_texto">
														<p class="lista_portfolio_p">
															<? php;
															$array = explode("pages/upload/", $post['conteudo']);

															if ($array[1]) {
																echo "$array[0]http://localhost/portfolio/CMS-Portfolio-Design/projeto/painel/pages/upload/$array[1]";
															} else {
																echo $post['conteudo'];
															}
							...
							<div class="compartilhar">
								<ul class="compartilhar_ul hzmp">
									...
									<li class="compartilhar_li">
										<p class="compartilhar_p hzmp">Compartilhar:</p>
									</li>
									<li class="compartilhar_li">
